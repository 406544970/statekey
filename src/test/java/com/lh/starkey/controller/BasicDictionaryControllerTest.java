...
//                    condList.append(String.format("%s", condRow));
     ...
     */
    private <M, O> String getValueByKeyName(M myObject, List<O> outObject
     ...
     * @throws IllegalAccessException
     */
    private <T, K> List<T> getClearRepetitionSingleAttributeListByKey(List<K> kList, String keyName, Class<K> kClass, Class<T> tClass) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        String keyMethodName = getCamelGetMethodName(keyName);
     ...
     * @throws IllegalAccessException
     */
    private <T, K> List<T> getClearRepetitionSingleAttributeList(List<K> kList, String keyMethodName, Class<K> kClass, Class<T> tClass) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
     ...
     * @throws IllegalAccessException
     */
    private <T, K> List<T> getKeyEqualsListByKeyName(List<T> tList, String keyName, List<K> valueList, Class<T> tClass) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        String keyMethodName = getCamelGetMethodName(keyName);
...
//      开始做好关联前的准备工作
        ...
        List<Integer> allLinkListClearOilUse = getClearRepetitionSingleAttributeListByKey(allLinkList, mainOilUseKeyId, OrderAll.class, Integer.class);
        List<OilUse> oilUsesFilter = getKeyEqualsListByKeyName(oilUses, linkOilUseKeyId, allLinkListClearOilUse, OilUse.class);

        List<Oil> oils = oilUseController.selectAllOil();
        String mainOilKeyId = "oilId";
        String linkOilKeyId = linkOilUseKeyId;
        List<Integer> allLinkListClearOil = getClearRepetitionSingleAttributeListByKey(allLinkList, mainOilKeyId, OrderAll.class, Integer.class);
        List<Oil> oilsFilter = getKeyEqualsListByKeyName(oils, linkOilKeyId, allLinkListClearOil, Oil.class);
        ...
        List<Integer> allLinkListClearOilBase = getClearRepetitionSingleAttributeListByKey(allLinkList, mainOilBaseKeyId, OrderAll.class, Integer.class);
        List<OilBase> oilBasesFilter = getKeyEqualsListByKeyName(oilBases, linkOilBaseKeyId, allLinkListClearOilBase, OilBase.class);
        ...
        for (OrderAll orderAll : allLinkList
            ...
            if (outMessage == null)
                outMessage = getValueByKeyName(orderAll, oilUsesFilter, mainOilUseKeyId, linkOilUseKeyId);
            if (outMessage == null)
                outMessage = getValueByKeyName(orderAll, oilsFilter, mainOilKeyId, linkOilKeyId);
            if (outMessage == null)
                outMessage = getValueByKeyName(orderAll, oilBasesFilter, mainOilBaseKeyId, linkOilBaseKeyId);
        }
